  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Interior studio for the Beach + Canal container villas at Moonlight Bay, Belize. Caribbean Salt palette, V2 and V3 walkthrough.",
      },
      { name: "theme-color", content: "#2c5854" },
    ],
    links: [
